...
- **Cleaner Filter UI Copy**: Removed redundant instructional helper text from the facet filters so the include/exclude controls read more directly and the UI stays quieter.
