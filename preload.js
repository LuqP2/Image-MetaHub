...
const electronAPI = {
  ...
  getEmbeddedMetadataBackupStatus: (args) => ipcRenderer.invoke('get-embedded-metadata-backup-status', args),
  writeEmbeddedMetadata: (args) => ipcRenderer.invoke('write-embedded-metadata', args),
  restoreEmbeddedMetadataBackup: (args) => ipcRenderer.invoke('restore-embedded-metadata-backup', args),
