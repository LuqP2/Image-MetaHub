...
const electronAPI = {
  ...
  getComfyUIBridgeDefaultDirectory: () => ipcRenderer.invoke('get-comfyui-bridge-default-directory'),
  writeComfyUIBridgePayload: (payload) => ipcRenderer.invoke('write-comfyui-bridge-payload', payload),
  openComfyUIBridgeDirectory: (bridgeDirectory) => ipcRenderer.invoke('open-comfyui-bridge-directory', bridgeDirectory),
