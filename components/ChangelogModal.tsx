            ...
            <>
              ...
              <div className="mb-6 p-4 bg-gradient-to-br from-blue-900/20 to-purple-900/20 border border-blue-500/30 rounded-lg">
                ...
                <div className="text-gray-300 space-y-3 text-sm leading-relaxed">
                  ...
                  <p>Image MetaHub 0.10.3 is here — continuing the 0.10.x line with important licensing and UX improvements.</p>

                  <p>With the 0.10.x line the goal is to push past "just a metadata viewer" and move towards a local AI image studio: smoother browsing, better quality-of-life in the UI, and new tools that are clearly beyond the basics. 0.10.3 focuses on making the Pro trial more transparent and opt-in, plus fixes for thumbnail flashing during indexing. The full list is in the changelog below — this is just the high-level context.</p>
                  ...
                  <p>Details on how to get a license are on <a href="https://www.imagemetahub.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 underline">the website</a>, or you can click the link Get Pro on the header.</p>
