    ...
    <div className="bg-gray-900/50 p-3 rounded-md border border-gray-700/50 relative group">
      <div className="flex justify-between items-start">
        ...
        {onCopy && (
            <button
              onClick={handleCopy}
              className={`transition-all duration-200 rounded focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-blue-500 outline-none ${copied ? 'opacity-100 text-green-400' : 'opacity-0 group-hover:opacity-100 text-gray-400 hover:text-white'}`}
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <TagInputCombobox
                  ...
                  placeholder="Add tag..."
                  inputClassName="peer w-full bg-gray-700/50 text-gray-200 border border-gray-600 rounded px-2 py-1 text-xs focus:outline-none focus:ring-1 focus:ring-blue-500 placeholder-gray-500"
